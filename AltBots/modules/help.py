...
HELP_BUTTON = [
    ...
    [
      Button.url("🍁 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚁 🍁", "https://t.me/don123s"),
      Button.url("💖 s𝚞𝚙𝚙𝚘𝚛𝚃 💖", "https://t.me/don_spambot")
    ]
  ]
    ...
    if event.query.user_id in SUDO_USERS:    
        await event.edit(
            ...
            buttons=[
              ...
              [
                Button.url("🦋⃟ ᴠ‌ɪ‌ᴘ‌ ⏤͟͟⃝🦎᭄🇩‌𝙊𝙣⏤͟͞🕊️⃝🩶_ 🥀🦋", "https://t.me/don123s"),
                Button.url("💫 𝚂𝚞𝚙𝚙𝚘𝚛𝚃 💫", "https://t.me/don_spambot")
              ]
            ]
          )
    else:
        await event.answer("MOON KO DM KRO SUDO KE LIYE @don123s" , cache_time=0, alert=True)
